...
EasyPose is a simple library of human pose estimation algorithms that can perform multi person pose estimation with fewer dependency packages. It can be easily applied to various applications, click [here](https://github.com/Dominic23331/EasyPose) to jump to it.
...
**If you want to get the trained ONNX files, please obtain them from [EasyPose](https://github.com/Dominic23331/EasyPose) ([RTMDet](https://huggingface.co/dominic23331/easypose/tree/main/detection/0.1.0/rtmdet), [RTMPose](https://huggingface.co/dominic23331/easypose/tree/main/pose/0.1.0/rtmpose)).**
